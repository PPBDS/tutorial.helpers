...
**tutorial.helpers** provides functions to help you write R tutorials, especially if you follow [my advice](https://ppbds.github.io/tutorial.helpers/articles/ai.html) about the best way to do so. This approach is currently used in several packages, [**positron.tutorials**](https://ppbds.github.io/positron.tutorials/).
...
To create a new tutorial, you first need a new directory, located in the `inst/tutorials` directory of your package. Once you create that directory, make sure that your R session is located within it. Then, issue this command:
...
This will create a new file, `tutorial.Rmd` in the current directory. This highly opinionated template provides [a framework for teaching students how to use AI to do data science](https://ppbds.github.io/tutorial.helpers/articles/ai.html).
...
The package includes three tutorials: "Getting Started," "Getting Started: Codespaces," "Introduction to R," and "Introduction to Python." You should require your students to complete one of the "Getting Started" tutorials if you are creating your own tutorials with **tutorial.helpers** package. For example, for Positron, have students run:

````
learnr::run_tutorial(getting-started", package = "tutorial.helpers")
````

This will teach them enough about how tutorials work to be able to complete the tutorials you write. If you are also teaching R, we strongly recommend the "Introduction to R" tutorial. 
