...
In order to access the RStudio addins, load the package. See the [addins vignette](https://ppbds.github.io/tutorial.helpers/articles/addins.html) for details about their use. Positron does not support addins, but the vignette explains how to use the same tools from the Console.

#### Tutorials

The package includes two tutorials: "Tutorials in Positron" and "Tutorials in RStudio." These provide an introduction to tutorials for beginning students. You should require your students to complete the tutorial associated with the IDE you are using if you are creating your own tutorials with **tutorial.helpers** package. 
