...
#'     - obj$id[[1]] "id"
#'
#'   Should the tibble be reorganized? Should tutorial info be included as a header?
#'   Also consider future support for unanswered questions and a richer metadata header.
#'
