...
# to the student QMD. Note that `df_print: default` above causes tibbles
# in the tutorial to appear as they would in the Console rather than as
# pretty html tables.
...
<!-- * Anytime you have a student `Cmd/Ctrl + Shift + Enter`, you ask for CP/CR and then provide your code. -->
...
<!-- XX: Delete this question if you do not make use of the `data` directory in this tutorial. Note the extra spaces after the command. These are needed to ensure separate lines for each command. -->
...
<!-- XX: You will probably have two or three Sections, in between the Introduction and Summary. We provide on example below. Before editing it, you may want to copy/paste it to create the skeleton for Second section. Any tutorial which both uses a lot of AI and is supposed to take an hour or so will probably only have two Sections.  -->
