...
<!-- I set this up so that, for me, it allows publishing to either shinyapps.io or Posit Cloud. Anyone else would need to connect their own accounts. Takes a while to run!  Sadly, both error with something about renv. Why should that matter? -->
