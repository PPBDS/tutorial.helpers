...
```{r tutorial-exercises-ex-1, exercise = TRUE}
...
```{r tutorial-exercises-ex-2, exercise = TRUE}
x <- 5
y <- 4
...
```{r tutorial-exercises-ex-3, exercise = TRUE}
...
```{r tutorial-exercises-ex-4, exercise = TRUE}
...
Run this command at the Console: `tutorial.helpers::set_binary_only_in_r_profile()`. CP/CR.

```{r tutorial-exercises-ex-8}
question_text(NULL,
	answer(NULL, correct = TRUE),
	allow_retry = TRUE,
	try_again_button = "Edit Answer",
