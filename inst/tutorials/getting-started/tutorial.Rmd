...
<!-- HK: Exercise 4 says the R version "should not be older" than the example, but the standard codespace may have an older R version -->
```{r exercises-4}
question_text(NULL,
...
<!-- HK: Exercise 9 says to copy "Exercise 10" header but the instructions say "above" when Exercise 10 is actually below -->
```{r exercises-9}
question_text(NULL,
