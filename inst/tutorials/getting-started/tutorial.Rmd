...
This tutorial introduces students using [GitHub Codespaces](https://github.com/features/codespaces) to R tutorials created with the [**learnr**](https://rstudio.github.io/learnr/) package. It is intended for beginning students who have never completed a tutorial.

Most students begin this tutorial after completing the setup steps outlined [here](https://ppbds.github.io/primer/getting-started.html#summary). If you have not done that, some of these questions may be confusing.
...
Now press the plus button in the bottom right. This opens a new bash terminal. A bash terminal is a text-based interface where you type commands to tell your computer what to do, such as navigating files, running programs, or managing projects.
...
By running the previous commands, we confirmed that we have a bash shell running and that [git](https://git-scm.com/), a version-control system, is installed.
...
`Ctrl + C` can stop any process running in the Terminal. This is often necessary.
