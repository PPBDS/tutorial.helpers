...
Click "Terminate Jobs". This will "grey out" the tutorial. (You might also have to close the tutorial window by hand.) 

Re-open this tutorial by clicking "Start Tutorial" in the Tutorial pane, just as you did at the start. Tutorial progress will have been saved automatically.
...
`
tutorial.helpers::set_rstudio_settings(set.binary = TRUE)
`
