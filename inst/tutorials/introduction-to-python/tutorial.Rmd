...
Installing Python on your machine is sometimes a complex process. Feel free to do so but, for this tutorial, we will work with Python in the cloud using [GitHub Codespaces](https://github.com/codespaces). 

Sign up for GitHub.

<!-- See the terminal. See the Python browser. Quit Python.  -->
