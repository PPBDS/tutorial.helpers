...
<!-- DK: Add a plot here. Need to import plotnine obviously, (and pyarrow?). Maybe create very simple plot. Initial code does not display. Retrieve the code with up arrow and add an assignment to p. Then call p.show() or whatever.  -->
