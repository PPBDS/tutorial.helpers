...
At the Console,  type `2 + 2` and hit `return/enter`.
...
<!-- DK: Add a plot here. Need to import plotnine obviously. Maybe create very simple plot. Initial code does not display. Retrieve the code with up arrow and add an assignment to p. Then save the object. Show an image of it appearing on our screen.  -->
