...
<!-- We need to expand the R-CMD-check.yaml file to include a Python set up, as well as installing necessary python packages. Perhaps we should have a requirements.txt file? Perhaps places in the inst/ directory? -->

<!-- Then, get rid of the ci check. The Python commands should work on GitHub, just as they do locally. -->
