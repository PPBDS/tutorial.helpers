...
author: "XX: Your Name"
tutorial:
  id: "XX: all lowercase id. It is the directory in which this tutorial is located. You may want to start the id with a number since tutorials are sorted by id when displayed."
output: 
  learnr::tutorial:
    df_print: default       # Cause printed tibbles to look the same as they do in the Console.
    progressive: true
    allow_skip: true
...
# XX: Add other packages you use. Add question which instructs students to add these
...
<!-- * Place any data needed for the tutorial in the data/ directory of the directory in which the tutorial is located. Have the student download it by hand. -->
...
```{r, echo=TRUE}
# x (Remove the hash mark and this comment. Leave just `x`.)
```
