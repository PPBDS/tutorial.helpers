...
2. Do a full test, which means running `devtools::check()`, the shortcut key for which is `Cmd/Ctrl + Shoft + E`. This is the equivalent of `R CMD check`. It validates package structure, documentation, tests, and compliance with CRAN standards. A good result would be `0 errors ✔ | 0 warnings ✔ | 0 notes ✔`, but don't worry too much about NOTES.
