...
The third step is only relevant for tutorial creators who follow [our advice](ai.html) concerning tutorial construction. In particular, `check_tutorial_defaults()` ensures that, somewhere in each tutorial, you have included the same key components as exist in the "Tutorial Helpers" R Markdown template.
