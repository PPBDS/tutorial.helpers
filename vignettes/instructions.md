...
The **tutorial.helpers** package provides a collection of RStudio Addins which facilitate the creation and testing of tutorial packages. Read about them in the "[Rstudio Addins](articles/addins.html)" vignette. Three of the vignettes create new exercises. A fourth, "Format Tutorial Chunk Labels," renumbers all the exercises in a tutorial if you add or remove an exercise. It also ensures consistency in code chunk labels. Highly recommended!
