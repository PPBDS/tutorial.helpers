...
<!-- Luke: Make sure that the three back tick trick is explained earlier in the document. If not, explain it the first time we show students. -->
...
<!-- DK: Change r to R everywhere. -->

<!-- DK: Clean up next paragraph. -->
...
<!-- DK: Outline what those four questions are, and give an example (using four backticks verbatim trick). -->
