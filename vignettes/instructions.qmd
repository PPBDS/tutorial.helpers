...
<!-- Luke: There are two ways for providing an answer to the question. One is in the r chunk, one is with flour backticks. The former must be used if you are going to ask students to copy/paste your code into the QMD in place of their current code. -->
