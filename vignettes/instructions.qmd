...
For a time, it seemed like using an environment started by four backticks along with `{verbatim}` and then ended with four more backticks worked but then, inexplicably, it stopped working.
