...
Instructors have different needs and priorities when it comes to processing student answers. We provide the functions `gather_submissions()`, `submissions_answers()`, and  `submissions_summary()` to help them. 
