...
RStudio Addins are not available in Positron. To use these tools, there are two key functions: `make_exercise()` and `check_current_tutorial()`. 
...
`make_exercise()` is the R function to run, if you are using Positron. By default, it produces a code exercise.
