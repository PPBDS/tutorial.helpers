...
```{r section-1-ex-1, exercise = TRUE}
...
```{r section-1-ex-2, exercise = TRUE}
...
```{r section-1-ex-4, exercise = TRUE}
...
```{r section-2-ex-1, exercise = TRUE}
...
```{r section-2-ex-3, exercise = TRUE}
...
```{r section-2-ex-4, exercise = TRUE}
