...
# write_rds(tibble_list_test, "tests/testthat/fixtures/check_membership_dir/tibble_list_test.rds")

tibble_list_test <- read_rds( "tests/testthat/fixtures/check_membership_dir/tibble_list_test.rds")
